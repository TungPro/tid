...
<div id="main_content">
	<div id="control_id">
		...
		<div id="col_right_810">
			<?php echo form_open_multipart('/admin/editclient/'.$client->client_id, array('id' => 'frmEditClient', 'name' => 'frmEditClient')); ?>
					
			<div id="box_edit_avata" class="box_810">
				<div class="title_box">
					<span class="inline-block">&nbsp;</span>Thay đổi dịch vụ kết nối
				</div>
				<div class="content_box">
					<?php if(isset($success) && $success):?>
					<div class="inform-success">
						<div class="inform-success-main">Sửa dịch vụ thành công.</div>
					</div>
					<?php endif;?>
								...
								<div class="form-main">
									...
									<div class="control01 w490">
										<div class="control01-main">
											<ul>
												<li><input type="text" class="w190" name="client_id" readonly="readonly"
													id="client_id"
													value="<?php echo set_value('client_id',$client->client_id); ?>" tabindex="33">
												</li>
											</ul>
											<div class="clr"></div>
										</div>
										...
										<div class="control01-main">
											<ul>
												<li><input type="text" class="w190" name="client_secret" id="client_secret"
													value="<?php echo set_value('client_secret',$client->client_secret); ?>" tabindex="33"></li>
											</ul>
											<div class="clr"></div>
										</div>
										...
										<div class="control01-main">
											<ul>
												<li><input type="text" class="w190" name="name" id="name"
													value="<?php echo set_value('name',$client->name); ?>" tabindex="33"></li>
											</ul>
											<div class="clr"></div>
										</div>
										...
										<div class="control01-main">
											<ul>
												<li><input type="text" class="w190" name="redirect_uri" id="redirect_uri"
													value="<?php echo set_value('redirect_uri',$client->redirect_uri); ?>" tabindex="33"></li>
											</ul>
											<div class="clr"></div>
										</div>
										...
										<div class="control01-main">
											<ul>
												<li><input type="text" class="w190" name="description"
													id="description"
													value="<?php echo set_value('description',$client->description); ?>"
													tabindex="33"></li>
											</ul>
											<div class="clr"></div>
										</div>
							...
							<li>
								<div class="form-main">
									...
									<div class="control01 w490">
										<div class="control01-main">
											<ul>
												<li><img src="<?php echo assets_url('/clients/'.$client->logo_url);?>"><br/><input type="file" name="logo" size="20" /><br/>
										...
										<div class="control01-main">
											<ul>
												<li><input type="radio" name="status" value="1"
													<?php echo set_radio('status', '1', $client->status == 1); ?> /> Mở <input
													type="radio" name="status" value="0"
													<?php echo set_radio('status', '0',$client->status == 0); ?> /> Đóng</li>
											</ul>
											<div class="clr"></div>
										</div>
